...
class MyParser
{
    ...
    { 
        ...
        switch(r.Parent.TableIndex)
        {
            ...
            case ProductionIndex.Access_spec_Private:                 
                // <ACCESS_SPEC> ::= private
                break;

            case ProductionIndex.Access_spec_Protected:                 
                // <ACCESS_SPEC> ::= protected
                break;

            case ProductionIndex.Access_spec_Public:                 
                // <ACCESS_SPEC> ::= public
                break;

            case ProductionIndex.Addop_Plus:                 
                // <ADDOP> ::= '+'
                break;

            case ProductionIndex.Addop_Minus:                 
                // <ADDOP> ::= '-'
                break;

            case ProductionIndex.Allocator_New_Lparan_Rparan:                 
                // <ALLOCATOR> ::= new <TYPE_ID> '(' <ARGLIST> ')'
                break;

            case ProductionIndex.Allocator_New_Lbracket_Rbracket:                 
            ...
            case ProductionIndex.Arglist2:                 
                // <ARGLIST> ::= 
                break;

            case ProductionIndex.Exprr:                 
                // <EXPRR> ::= <EXPR>
                break;

            case ProductionIndex.Exprr_Comma:                 
                // <EXPRR> ::= <EXPR> ',' <EXPRR>
                break;

            case ProductionIndex.Assignstmt_Eq:                 
                // <ASSIGNSTMT> ::= <FACTOR> '=' <EXPR>
                break;

            case ProductionIndex.Bexpr:                 
                // <BEXPR> ::= <SIMPLEEXPR>
                break;

            case ProductionIndex.Bexpr2:                 
                // <BEXPR> ::= <SIMPLEEXPR> <RELOP> <SIMPLEEXPR>
                break;

            case ProductionIndex.Block_Begin_End:                 
                // <BLOCK> ::= <VARDECS> begin <STMTLIST> end
                break;

            case ProductionIndex.Body:                 
                // <BODY> ::= <SUPER_INIT> <THIS_INIT> <BLOCK>
                break;

            case ProductionIndex.Callstmt_Call:                 
                // <CALLSTMT> ::= call <FACTOR>
                break;

            case ProductionIndex.Cast_expr_Cast_Lparan_Comma_Rparan:                 
                // <CAST_EXPR> ::= cast '(' <TYPE_ID> ',' <EXPR> ')'
                break;

            case ProductionIndex.Catch_clause_Catch_Lparan_Id_Rparan:                 
                // <CATCH_CLAUSE> ::= catch '(' <TYPE_ID> Id ')' <STMTLIST>
                break;

            case ProductionIndex.Cexpr:                 
                // <CEXPR> ::= <BEXPR>
                break;

            case ProductionIndex.Cexpr_And:                 
                // <CEXPR> ::= <BEXPR> and <CEXPR>
                break;

            case ProductionIndex.Class_Class_Id_Is_End_Id:                 
                // <CLASS> ::= class Id <SUPER_CLASS> is <CLASS_MEMBERR> end Id
                break;

            case ProductionIndex.Class_memberr:                 
                // <CLASS_MEMBERR> ::= <CLASS_MEMBER> <CLASS_MEMBERR>
                break;

            case ProductionIndex.Class_memberr2:                 
                // <CLASS_MEMBERR> ::= 
                break;

            case ProductionIndex.Class_member:                 
                // <CLASS_MEMBER> ::= <FIELD_DECL>
                break;

            case ProductionIndex.Class_member2:                 
                // <CLASS_MEMBER> ::= <METHOD_DECL>
                break;

            case ProductionIndex.Elsepart_Else:                 
                // <ELSEPART> ::= else <STMTLIST>
                break;

            case ProductionIndex.Elsepart:                 
                // <ELSEPART> ::= 
                break;
            ...
            case ProductionIndex.Expr_Or:                 
                // <EXPR> ::= <CEXPR> or <EXPR>
                break;

            case ProductionIndex.Factor_Minus:                 
                // <FACTOR> ::= '-' <FACTOR>
                break;

            case ProductionIndex.Factor_Not:                 
                // <FACTOR> ::= not <FACTOR>
                break;

            case ProductionIndex.Factor_Number:                 
                // <FACTOR> ::= Number
                break;

            case ProductionIndex.Factor_False:                 
                // <FACTOR> ::= false
                break;

            case ProductionIndex.Factor_True:                 
                // <FACTOR> ::= true
                break;

            case ProductionIndex.Factor_Null:                 
                // <FACTOR> ::= null
                break;
            ...
            case ProductionIndex.Factor2:                 
                // <FACTOR> ::= <CAST_EXPR>
                break;

            case ProductionIndex.Factor3:                 
                // <FACTOR> ::= <VALUE_OR_REF> <MEMBER_PARTT>
                break;

            case ProductionIndex.Member_partt:                 
                // <MEMBER_PARTT> ::= <MEMBER_PART> <MEMBER_PARTT>
                break;

            case ProductionIndex.Member_partt2:                 
                // <MEMBER_PARTT> ::= 
                break;

            case ProductionIndex.Field_decl_Id_Semi:                 
                // <FIELD_DECL> ::= <ACCESS_SPEC> <TYPE> Id <FIELD_DECLL> ';'
                break;

            case ProductionIndex.Field_decll_Comma_Id:                 
                // <FIELD_DECLL> ::= ',' Id <FIELD_DECLL>
                break;

            case ProductionIndex.Field_decll:                 
                // <FIELD_DECLL> ::= 
                break;

            case ProductionIndex.Ifstmt_If_Then_End_If:                 
                // <IFSTMT> ::= if <EXPR> then <STMTLIST> <ELSEIF_PART> <ELSEPART> end if
                break;

            case ProductionIndex.Elseif_part_Elsif_Then:                 
                // <ELSEIF_PART> ::= elsif <EXPR> then <STMTLIST> <ELSEIF_PART>
                break;

            case ProductionIndex.Elseif_part:                 
                // <ELSEIF_PART> ::= 
                break;

            case ProductionIndex.Inputstmt_Input_Gtgt:                 
                // <INPUTSTMT> ::= input '>>' <FACTOR>
                break;

            case ProductionIndex.Loopstmt_Loop_End_Loop:                 
                // <LOOPSTMT> ::= loop <STMTLIST> end loop
                break;

            case ProductionIndex.Member_part_Dot_Id:                 
                // <MEMBER_PART> ::= '.' Id
                break;

            case ProductionIndex.Member_part_Dot_Id_Lparan_Rparan:                 
                // <MEMBER_PART> ::= '.' Id '(' <ARGLIST> ')'
                break;

            case ProductionIndex.Member_part_Dot_Id_Lbracket_Rbracket:                 
                // <MEMBER_PART> ::= '.' Id '[' <EXPR> ']'
                break;

            case ProductionIndex.Method_Method_Lparan_Rparan_Is_Id:                 
                // <METHOD> ::= method <M_TYPE> <METHOD_ID> '(' <PARAMETERS> ')' is <BODY> Id
                break;

            case ProductionIndex.Method_decl_Method_Id_Lparan_Rparan_Semi:                 
                // <METHOD_DECL> ::= <ACCESS_SPEC> method <M_TYPE> Id '(' <PARAMETER_DECL> ')' ';'
                break;

            case ProductionIndex.Method_id_Id_Coloncolon_Id:                 
                // <METHOD_ID> ::= Id '::' Id
                break;

            case ProductionIndex.Method_id_Id:                 
                // <METHOD_ID> ::= Id
                break;

            case ProductionIndex.M_type:                 
                // <M_TYPE> ::= <TYPE>
                break;

            case ProductionIndex.M_type_Void:                 
                // <M_TYPE> ::= void
                break;

            case ProductionIndex.Multop_Times:                 
                // <MULTOP> ::= '*'
                break;

            case ProductionIndex.Multop_Div:                 
                // <MULTOP> ::= '/'
                break;

            case ProductionIndex.Multop_Mod:                 
                // <MULTOP> ::= mod
                break;

            case ProductionIndex.Optional_id_Id:                 
                // <OPTIONAL_ID> ::= Id
                break;

            case ProductionIndex.Optional_id:                 
                // <OPTIONAL_ID> ::= 
                break;

            case ProductionIndex.Outputstmt_Output_Ltlt:                 
                // <OUTPUTSTMT> ::= output '<<' <EXPR>
                break;

            case ProductionIndex.Outputstmt_Output_Ltlt2:                 
                // <OUTPUTSTMT> ::= output '<<' <STRING_OR_CHAR>
                break;

            case ProductionIndex.String_or_char_Stringliteral:                 
                // <STRING_OR_CHAR> ::= StringLiteral
                break;

            case ProductionIndex.String_or_char_Charliteral:                 
                // <STRING_OR_CHAR> ::= CharLiteral
                break;

            case ProductionIndex.String_or_char:                 
                // <STRING_OR_CHAR> ::= 
                break;

            case ProductionIndex.Parameter_decl:                 
                // <PARAMETER_DECL> ::= <TYPE> <OPTIONAL_ID> <PARAMETER_DECLL>
                break;

            case ProductionIndex.Parameter_decl2:                 
                // <PARAMETER_DECL> ::= 
                break;

            case ProductionIndex.Parameter_decll_Comma:                 
                // <PARAMETER_DECLL> ::= ',' <TYPE> <OPTIONAL_ID> <PARAMETER_DECLL>
                break;

            case ProductionIndex.Parameter_decll:                 
                // <PARAMETER_DECLL> ::= 
                break;

            case ProductionIndex.Parameters_Id:                 
            ...
            case ProductionIndex.Typee_Comma_Id:                 
                // <TYPEE> ::= ',' <TYPE> Id <TYPEE>
                break;

            case ProductionIndex.Typee:                 
                // <TYPEE> ::= 
                break;

            case ProductionIndex.Relop_Eqeq:                 
                // <RELOP> ::= '=='
                break;

            case ProductionIndex.Relop_Lt:                 
                // <RELOP> ::= '<'
                break;

            case ProductionIndex.Relop_Lteq:                 
                // <RELOP> ::= '<='
                break;

            case ProductionIndex.Relop_Gt:                 
                // <RELOP> ::= '>'
                break;

            case ProductionIndex.Relop_Gteq:                 
                // <RELOP> ::= '>='
                break;

            case ProductionIndex.Relop_Num:                 
                // <RELOP> ::= '#'
                break;

            case ProductionIndex.Simpleexpr:                 
                // <SIMPLEEXPR> ::= <TERM> <SIMPLEEXPRR>
                break;

            case ProductionIndex.Simpleexprr:                 
                // <SIMPLEEXPRR> ::= <ADDOP> <TERM> <SIMPLEEXPRR>
                break;

            case ProductionIndex.Simpleexprr2:                 
                // <SIMPLEEXPRR> ::= 
                break;
            ...
            case ProductionIndex.Stmt6:                 
                // <STMT> ::= <CALLSTMT>
                break;

            case ProductionIndex.Stmt7:                 
                // <STMT> ::= <OUTPUTSTMT>
                break;

            case ProductionIndex.Stmt8:                 
                // <STMT> ::= <INPUTSTMT>
                break;

            case ProductionIndex.Stmt_Continue:                 
                // <STMT> ::= continue
                break;

            case ProductionIndex.Stmt_Break:                 
                // <STMT> ::= break
                break;

            case ProductionIndex.Stmt_Return:                 
                // <STMT> ::= return
                break;

            case ProductionIndex.Stmt_Return2:                 
                // <STMT> ::= return <EXPR>
                break;

            case ProductionIndex.Stmt_Exit:                 
                // <STMT> ::= exit
                break;

            case ProductionIndex.Stmt_Throw:                 
                // <STMT> ::= throw <EXPR>
                break;
            ...
            case ProductionIndex.Stmtlistt_Semi:                 
                // <STMTLISTT> ::= <STMT> ';' <STMTLISTT>
                break;

            case ProductionIndex.Stmtlistt:                 
                // <STMTLISTT> ::= 
                break;

            case ProductionIndex.Super_init_Super_Lparan_Rparan:                 
                // <SUPER_INIT> ::= super '(' <ARGLIST> ')'
                break;

            case ProductionIndex.Super_init:                 
                // <SUPER_INIT> ::= 
                break;

            case ProductionIndex.Super_class_Extends_Id:                 
                // <SUPER_CLASS> ::= extends Id
                break;

            case ProductionIndex.Super_class:                 
                // <SUPER_CLASS> ::= 
                break;
            ...
            case ProductionIndex.Termm:                 
                // <TERMM> ::= <MULTOP> <FACTOR> <TERMM>
                break;

            case ProductionIndex.Termm2:                 
                // <TERMM> ::= 
                break;

            case ProductionIndex.This_init_This_Lparan_Rparan:                 
                // <THIS_INIT> ::= this '(' <ARGLIST> ')'
                break;

            case ProductionIndex.This_init:                 
                // <THIS_INIT> ::= 
                break;

            case ProductionIndex.Trystmt_Try_End_Try:                 
                // <TRYSTMT> ::= try <STMTLIST> <CATCH_CLAUSE> <CATCH_CLAUSEE> end try
                break;

            case ProductionIndex.Catch_clausee:                 
                // <CATCH_CLAUSEE> ::= <CATCH_CLAUSE> <CATCH_CLAUSEE>
                break;

            case ProductionIndex.Catch_clausee2:                 
                // <CATCH_CLAUSEE> ::= 
                break;
            ...
            case ProductionIndex.Type_Lbracketrbracket:                 
                // <TYPE> ::= <TYPE_ID> '[]'
                break;

            case ProductionIndex.Type_id_Integer:                 
                // <TYPE_ID> ::= integer
                break;

            case ProductionIndex.Type_id_Boolean:                 
                // <TYPE_ID> ::= boolean
                break;

            case ProductionIndex.Type_id_Id:                 
                // <TYPE_ID> ::= Id
                break;

            case ProductionIndex.Value_or_ref_This:                 
                // <VALUE_OR_REF> ::= this
                break;

            case ProductionIndex.Value_or_ref_Super:                 
                // <VALUE_OR_REF> ::= super
                break;

            case ProductionIndex.Value_or_ref_Id:                 
                // <VALUE_OR_REF> ::= Id
                break;

            case ProductionIndex.Value_or_ref_Id_Lbracket_Rbracket:                 
                // <VALUE_OR_REF> ::= Id '[' <EXPR> ']'
                break;

            case ProductionIndex.Value_or_ref_Id_Lparan_Rparan:                 
                // <VALUE_OR_REF> ::= Id '(' <ARGLIST> ')'
                break;

            case ProductionIndex.Value_or_ref_Lparan_Rparan:                 
                // <VALUE_OR_REF> ::= '(' <EXPR> ')'
                break;

            case ProductionIndex.Vardeclist_Id_Semi:                 
                // <VARDECLIST> ::= <TYPE> Id <TYPEEE> ';'
                break;

            case ProductionIndex.Typeee_Comma_Id:                 
                // <TYPEEE> ::= ',' Id <TYPEE>
                break;

            case ProductionIndex.Typeee:                 
                // <TYPEEE> ::= 
                break;

            case ProductionIndex.Vardecs_Declare:                 
                // <VARDECS> ::= declare <VARDECLIST> <VARDECLISTT>
                break;

            case ProductionIndex.Vardecs:                 
                // <VARDECS> ::= 
                break;

            case ProductionIndex.Vardeclistt:                 
                // <VARDECLISTT> ::= <VARDECLIST> <VARDECLISTT>
                break;

            case ProductionIndex.Vardeclistt2:                 
                // <VARDECLISTT> ::= 
                break;
